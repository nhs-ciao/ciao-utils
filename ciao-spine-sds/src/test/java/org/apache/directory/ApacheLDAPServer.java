 ...
 * into an application.
 * Example taken from: https://cwiki.apache.org/confluence/display/DIRxSRVx11/4.1.+Embedding+ApacheDS+into+an+application
 *
...
public class ApacheLDAPServer
{
    ...
    public static void main( String[] args ) 
    {
        try
        {
            ...
            // Create the server
            ApacheLDAPServer ads = new ApacheLDAPServer( workDir );
